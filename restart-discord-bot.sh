#!/usr/bin/env bash
#
# Restart (or inspect) the eeesoc Discord soccer bot inside the dashboard
# container. Answers !soc live / upcoming / winprob / similar etc.
#
...
CONTAINER="${EEESOC_CONTAINER:-eeesoc-dashboard}"
